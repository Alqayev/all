...
<section class="our-gallery slideanim" id="gallery">
    <fmt:message key="Caregory4alt5ic1or.ab" var="Caregory4alt5ic1or"/>
    <h3 class="text-center slideanim">${Caregory4alt5ic1or}</h3>
    <fmt:message key="Caregory4alt5ic2or.ab" var="Caregory4alt5ic2or"/>
    <p class="text-center slideanim">${Caregory4alt5ic2or}</p>
    <div class="container">
