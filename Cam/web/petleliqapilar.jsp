...
<section class="our-gallery slideanim" id="gallery">
    <fmt:message key="Caregory6alt4ic1.ab" var="Caregory6alt4ic1"/>
    <h3 class="text-center slideanim">${Caregory6alt4ic1}</h3>
    <fmt:message key="Caregory6alt4ic2.ab" var="Caregory6alt4ic2"/>
    <p class="text-center slideanim">${Caregory6alt4ic2}</p>
    <div class="container">
