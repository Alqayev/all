...
<section class="our-gallery slideanim" id="gallery">
    <fmt:message key="Caregory4alt2ic1.ab" var="Caregory4alt2ic1"/>
    <h3 class="text-center slideanim">${Caregory4alt2ic1}</h3>
    <fmt:message key="Caregory4alt2ic2.ab" var="Caregory4alt2ic2"/>
    <p class="text-center slideanim">${Caregory4alt2ic2}</p>
    <div class="container">
