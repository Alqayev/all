...
<section class="our-gallery slideanim" id="gallery">
    <fmt:message key="Caregory3alt1ic1.ab" var="Caregory3alt1ic1"/>
    <h3 class="text-center slideanim">${Caregory3alt1ic1}</h3>
    <fmt:message key="Caregory3alt1ic2.ab" var="Caregory3alt1ic2"/>
    <p class="text-center slideanim">${Caregory3alt1ic2}</p>
    <div class="container">
