...
<section class="our-gallery slideanim" id="gallery">
    <fmt:message key="Caregory3alt4ic1or.ab" var="Caregory3alt4ic1or"/>
    <h3 class="text-center slideanim">${Caregory3alt4ic1or}</h3>
    <fmt:message key="Caregory3alt4ic2or.ab" var="Caregory3alt4ic2or"/>
    <p class="text-center slideanim">${Caregory3alt4ic2or}</p>
    <div class="container">
